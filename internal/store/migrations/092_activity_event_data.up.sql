CREATE TABLE activity_events_i18n (
...
INSERT INTO activity_events_i18n (
    id, type, timestamp, payload_json,
...
ALTER TABLE activity_events_i18n RENAME TO activity_events;
