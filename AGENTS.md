...
- **Deployment:** Single container (Go binary with embedded frontend assets via go:embed). Deployment manifests live outside this repo.
...
- Dashboard is served at hive.saffronbun.com
