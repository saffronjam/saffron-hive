...
type Documents = {
    ...
    "\n\t\tquery GroupsPageDevices {\n\t\t\tdevices {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t\ttype\n\t\t\t\tcapabilities { name type values valueMin valueMax unit access }\n\t\t\t\tsource\n\t\t\t\tavailable\n\t\t\t\tlastSeen\n\t\t\t\tstate {\n\t\t\t\t\ton\n\t\t\t\t\tbrightness\n\t\t\t\t\tcolorTemp\n\t\t\t\t\tcolor { r g b x y }\n\t\t\t\t\ttransition\n\t\t\t\t\ttemperature\n\t\t\t\t\thumidity\n\t\t\t\t\tpressure\n\t\t\t\t\tilluminance\n\t\t\t\t\tbattery\n\t\t\t\t\tpower\n\t\t\t\t\tvoltage\n\t\t\t\t\tcurrent\n\t\t\t\t\tenergy\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t": typeof types.GroupsPageDevicesDocument,
...
const documents: Documents = {
    ...
    "\n\t\tquery DashboardAutomations {\n\t\t\tautomations {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t}\n\t\t}\n\t": types.DashboardAutomationsDocument,
    "\n\t\tmutation ApplyScene($sceneId: ID!) {\n\t\t\tapplyScene(sceneId: $sceneId) {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t}\n\t\t}\n\t": types.ApplySceneDocument,
    "\n\t\tmutation DashboardSetDeviceState($deviceId: ID!, $state: DeviceStateInput!) {\n\t\t\tsetDeviceState(deviceId: $deviceId, state: $state) {\n\t\t\t\tid\n\t\t\t\tstate {\n\t\t\t\t\ton\n\t\t\t\t\tbrightness\n\t\t\t\t\tcolorTemp\n\t\t\t\t\tcolor { r g b x y }\n\t\t\t\t\ttransition\n\t\t\t\t\ttemperature\n\t\t\t\t\thumidity\n\t\t\t\t\tpressure\n\t\t\t\t\tilluminance\n\t\t\t\t\tbattery\n\t\t\t\t\tpower\n\t\t\t\t\tvoltage\n\t\t\t\t\tcurrent\n\t\t\t\t\tenergy\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t": types.DashboardSetDeviceStateDocument,
    "\n\t\tsubscription DashboardAutomationNodeActivated {\n\t\t\tautomationNodeActivated {\n\t\t\t\tautomationId\n\t\t\t\tnodeId\n\t\t\t\tactive\n\t\t\t}\n\t\t}\n\t": types.DashboardAutomationNodeActivatedDocument,
    ...
    "\n\t\tmutation DeviceListAddRoomDevice($input: AddRoomDeviceInput!) {\n\t\t\taddRoomDevice(input: $input) {\n\t\t\t\tid\n\t\t\t}\n\t\t}\n\t": types.DeviceListAddRoomDeviceDocument,
    ...
    "\n\t\tmutation DeviceDetailAddRoomDevice($input: AddRoomDeviceInput!) {\n\t\t\taddRoomDevice(input: $input) { id }\n\t\t}\n\t": types.DeviceDetailAddRoomDeviceDocument,
    "\n\t\tmutation DeviceDetailRemoveRoomDevice($roomId: ID!, $deviceId: ID!) {\n\t\t\tremoveRoomDevice(roomId: $roomId, deviceId: $deviceId) { id }\n\t\t}\n\t": types.DeviceDetailRemoveRoomDeviceDocument,
    ...
    "\n\t\tquery GroupsPageDevices {\n\t\t\tdevices {\n\t\t\t\tid\n\t\t\t\tname\n\t\t\t\ttype\n\t\t\t\tcapabilities { name type values valueMin valueMax unit access }\n\t\t\t\tsource\n\t\t\t\tavailable\n\t\t\t\tlastSeen\n\t\t\t\tstate {\n\t\t\t\t\ton\n\t\t\t\t\tbrightness\n\t\t\t\t\tcolorTemp\n\t\t\t\t\tcolor { r g b x y }\n\t\t\t\t\ttransition\n\t\t\t\t\ttemperature\n\t\t\t\t\thumidity\n\t\t\t\t\tpressure\n\t\t\t\t\tilluminance\n\t\t\t\t\tbattery\n\t\t\t\t\tpower\n\t\t\t\t\tvoltage\n\t\t\t\t\tcurrent\n\t\t\t\t\tenergy\n\t\t\t\t}\n\t\t\t}\n\t\t}\n\t": types.GroupsPageDevicesDocument,
