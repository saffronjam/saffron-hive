...
export type ScenesPageDevicesQuery = { __typename?: 'Query', devices: Array<{ __typename?: 'Device', id: string, name: string, type: string, capabilities: Array<{ __typename?: 'Capability', name: string, access: number }> }> };
