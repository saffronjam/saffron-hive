...
export type SceneEditSetDeviceStateMutation = { __typename?: 'Mutation', setTargetState: boolean };

export type SceneEditEffectsQueryVariables = Exact<{ [key: string]: never; }>;


export type SceneEditEffectsQuery = { __typename?: 'Query', effects: Array<{ __typename?: 'Effect', id: string, name: string, icon?: string | null, kind: EffectKind, nativeName?: string | null, loop: boolean, requiredCapabilities: Array<string> }>, nativeEffectOptions: Array<{ __typename?: 'NativeEffectOption', name: string, displayName: string, confirmedDeviceCount: number, untestedDeviceCount: number, unsupportedDeviceCount: number }> };
