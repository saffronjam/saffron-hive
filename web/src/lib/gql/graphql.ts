...
export type SceneEditUpdateMutation = { __typename?: 'Mutation', updateScene: { __typename?: 'Scene', id: string, name: string, icon?: string | null, rooms: Array<{ __typename?: 'Room', id: string, name: string, icon?: string | null }>, actions: Array<{ __typename?: 'SceneAction', targetType: string, targetId: string }>, devicePayloads: Array<{ __typename?: 'SceneDevicePayload', deviceId: string, payload: string }> } };
