...
export type DashboardScenesQuery = { __typename?: 'Query', scenes: Array<{ __typename?: 'Scene', id: string, name: string, icon?: string | null, rooms: Array<{ __typename?: 'Room', id: string }>, actions: Array<{ __typename?: 'SceneAction', targetType: string, targetId: string }> }> };
