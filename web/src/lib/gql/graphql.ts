...
export type DeviceListRoomsQuery = { __typename?: 'Query', rooms: Array<{ __typename?: 'Room', id: string, name: string, devices: Array<{ __typename?: 'Device', id: string }> }> };

export type DeviceListGroupsQueryVariables = Exact<{ [key: string]: never; }>;


export type DeviceListGroupsQuery = { __typename?: 'Query', groups: Array<{ __typename?: 'Group', id: string, name: string, members: Array<{ __typename?: 'GroupMember', memberType: string, memberId: string }> }> };
