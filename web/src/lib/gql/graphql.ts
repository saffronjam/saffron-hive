...
export type DynamicSceneSource = {
  ...
  presetTitle?: Maybe<Scalars['String']['output']>;
...
export type BrowserSceneFixturesQuery = { __typename?: 'Query', devices: Array<{ __typename?: 'Device', id: string, friendlyName: string, type: string }>, vibePresets: Array<{ __typename?: 'VibePreset', id: string, title: string }> };
...
export type GuidedVibeChoicesQuery = { __typename?: 'Query', guidedVibeRound: { __typename?: 'GuidedVibeRound', round: number, canFinish: boolean, complete: boolean, options: Array<{ __typename?: 'GuidedVibeOption', id: string, title: string, preview: { __typename?: 'ScenePreview', width: number, height: number, pixels: Array<{ __typename?: 'PreviewPixel', r: number, g: number, b: number }>, swatches: Array<{ __typename?: 'PreviewSwatch', x: number, y: number, color: { __typename?: 'PreviewPixel', r: number, g: number, b: number } }> } }> } };
...
export type MaintenanceTasksQuery = { __typename?: 'Query', maintenanceTasks: Array<{ __typename?: 'MaintenanceTask', id: string, kind: MaintenanceKind, title: string, detail: string, action: string, currentValue?: string | null, targetValue?: string | null, actionUrl?: string | null, device?: { __typename?: 'Device', id: string, name?: string | null, friendlyName: string, icon?: string | null, type: string, available: boolean, disabled: boolean, deleted: boolean, roles: { __typename?: 'DeviceRoles', contact?: ContactRole | null } } | null }> };
...
export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, username: string, name: string, avatarPath?: string | null, theme?: Theme | null, timeFormat?: TimeFormat | null, temperatureUnit?: TemperatureUnit | null, hapticsEnabled?: boolean | null, createdAt?: any | null, mustChangePassword?: boolean | null } | null };
...
export type VibeCatalogQuery = { __typename?: 'Query', vibePresets: Array<{ __typename?: 'VibePreset', id: string, title: string, category: string, domain: VibeFieldDomain, seed: string, brightness: number, movement: number, cycleSeconds: number, preview: { __typename?: 'ScenePreview', width: number, height: number, pixels: Array<{ __typename?: 'PreviewPixel', r: number, g: number, b: number }>, swatches: Array<{ __typename?: 'PreviewSwatch', x: number, y: number, color: { __typename?: 'PreviewPixel', r: number, g: number, b: number } }> } }> };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AuthPayload', token: string, user: { __typename?: 'User', id: string, username: string, name: string, avatarPath?: string | null, theme?: Theme | null, timeFormat?: TimeFormat | null, temperatureUnit?: TemperatureUnit | null, hapticsEnabled?: boolean | null, createdAt?: any | null, mustChangePassword?: boolean | null } } };
...
export const GroupCommandsSetTargetStateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"GroupCommandsSetTargetState"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"targetType"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CommandTargetType"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"targetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"state"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeviceStateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"setTargetState"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"targetType"},"value":{"kind":"Variable","name":{"kind":"Name","value":"targetType"}}},{"kind":"Argument","name":{"kind":"Name","value":"targetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"targetId"}}},{"kind":"Argument","name":{"kind":"Name","value":"state"},"value":{"kind":"Variable","name":{"kind":"Name","value":"state"}}}]}]}}]} as unknown as DocumentNode<GroupCommandsSetTargetStateMutation, GroupCommandsSetTargetStateMutationVariables>;
