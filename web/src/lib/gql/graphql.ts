...
export type NativeEffectOptionsQuery = { __typename?: 'Query', nativeEffectOptions: Array<{ __typename?: 'NativeEffectOption', name: string, displayName: string, supportedDeviceCount: number, source: string }> };
...
export type EffectsPageNativeOptionsQuery = { __typename?: 'Query', nativeEffectOptions: Array<{ __typename?: 'NativeEffectOption', name: string, displayName: string, source: string, supportedDeviceCount: number }> };
...
export type MaintenanceTasksQuery = { __typename?: 'Query', maintenanceTasks: Array<{ __typename?: 'MaintenanceTask', id: string, kind: MaintenanceKind, title: string, detail: string, action: string, currentValue?: string | null, targetValue?: string | null, actionUrl?: string | null, device?: { __typename?: 'Device', id: string, name?: string | null, friendlyName: string, icon?: string | null, type: string, available: boolean, disabled: boolean, roles: { __typename?: 'DeviceRoles', contact?: ContactRole | null } } | null }> };
